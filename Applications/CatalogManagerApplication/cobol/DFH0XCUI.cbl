      ...
      *****************************************************************
      *                                                               *
      *  MODULE NAME = DFH0XCUI                                       *
      *                                                               *
      *  DESCRIPTIVE NAME = CICS TS  (Samples) Example Application -  *
      *                     BMS manager for Web Service Client        *
      *                                                               *
      *                                                               *
      *                                                               *
      ...
      *                                                               *
      *  FUNCTION =                                                   *
      *  This module handles the BMS interactions for the CICS Web    *
      *  Service client for the Example Application                   *
      *                                                               *
      *-------------------------------------------------------------  *
      *                                                               *
      *  ENTRY POINT = DFH0XCUI                                       *
      *                                                               *
      *-------------------------------------------------------------  *
      *                                                               *
      *  CHANGE ACTIVITY :                                            *
      *                                                               *
      *       $MOD(DFH0XCUI),COMP(SAMPLES),PROD(CICS TS ):            *
      *                                                               *
      *   PN= REASON REL YYMMDD HDXXIII : REMARKS                     *
      *  $D0= I07544 640 050113 HDIPCB  : ExampleApp CICS client code *
      *  $D1= I07544 640 050208 HDIPCB  : Definitions for Example App *
      *  $P2= D20555 660 080417 HDFFCMS : Typos in Web Service Example*
      *                                                               *
      ...
      * Error Message structure
       01  ERROR-MSG.
           ...
           03 FILLER                   PIC X(9)  VALUE ' DFH0XCUI'.
      ...
      * Working storage copy of the Communication Area
       01 WS-COMMAREA.
           ...
           03 WS-VARIABLES.
               05 WS-WEBSERVICE-CLIENT-PROG    PIC X(8)
                                                   VALUE 'DFH0XECC'.
      ...
      *        Input not recognised - send error message
                   MOVE 'OPTION NOT RECOGNISED' TO MSG1O
                   PERFORM INVALID-MENU-INPUT
           END-EVALUATE
        ...
        PROCESS-MENU-ORDER-REQUEST.
           ...
           EVALUATE TRUE
               WHEN ITEM-REFI EQUAL LOW-VALUE OR SPACE
                   MOVE 'TO PLACE ORDER PLEASE ENTER A VALID ITEM REF'
                       TO MSG1O
                   PERFORM INVALID-MENU-INPUT
               ...
               WHEN OTHER
                   ...
                   EXEC CICS LINK PROGRAM(WS-WEBSERVICE-CLIENT-PROG)
                                  COMMAREA(WS-COMMAREA)
